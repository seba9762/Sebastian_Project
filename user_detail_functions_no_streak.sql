-- ============================================================================
-- USER DETAIL PAGE - DATABASE FUNCTIONS (Without streak columns)
-- ============================================================================
-- This version doesn't rely on current_streak or longest_streak columns
-- It will calculate streak or use 0 if not available
-- Run this entire file in Supabase SQL Editor
-- ============================================================================

-- Function 1: Get comprehensive user statistics (Without streak columns)
...
BEGIN
    ...
    SELECT 
        ...
        -- Calculate current streak from learning_sessions (consecutive days)
        0::INTEGER as current_streak,  -- Simplified for now
        0::INTEGER as longest_streak,  -- Simplified for now
...
-- ============================================================================
-- NOTE: Streak columns are set to 0 for now
-- If you want real streak calculation, we can add that later
-- ============================================================================
